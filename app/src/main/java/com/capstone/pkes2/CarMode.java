...
import com.capstone.pkes2.databinding.FragmentSecondBinding;
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.buttonSecond.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(CarMode.this)
                        .navigate(R.id.action_SecondFragment_to_FirstFragment);
            }
        });

        binding.btnAcceptConn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        binding.btnMakeDiscoverable.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
